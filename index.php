...
<body>
    ...
    <div class="card" style="background-color:#b3b3b3 ">
      <div class="row">
        <div class="text-center mx-auto col-md-12">
          <br>
          <h1 class="mb-4">Tarif Rental Studio Supernova</h1>
        </div>
      </div>
            ...
            <div class="card-body p-4">
              <div class="row">
                ...
                <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                  <p class="mb-0 lead">Nur A</p>
                </div>
              </div>
              <p class="mt-3 mb-0">"Tempat Yang Cocok Untuk Latihan Band"</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-6 p-3">
          <div class="card">
            <div class="card-body p-4">
              <div class="row">
                ...
                <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                  <p class="mb-0 lead">LQDERUYT</p>
                </div>
              </div>
              <p class="mt-3 mb-0">"Studio supernova sangat lengkap alat musiknya , mulai dari percussion sampai alat band lainnya.'</p>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-body p-4">
              <div class="row">
                ...
                <div class="d-flex  col-md-8 flex-column justify-content-center align-items-start col-9">
                  <p class="mb-0 lead">Mbah D</p>
                </div>
              </div>
              <p class="mt-3 mb-0">"Mantap tempatnya enak. alatnya juga lengkap!"</p>
            </div>
          </div>
        </div>
        </div>
  ...
  <div class="py-5 bg-light" id="kontak">
    <div class="container">
      <div class="row">
        <div class="mx-auto text-center col-lg-6">
          <h1 class="mb-3">Hubungi Kami</h1>
          <p class="lead mb-4">Hubungi kami untuk informasi lebih lanjut<br><a href="https://wa.me/6281294493204" target="_blank">Whatsapp</a></p>
        </div>
      </div>
      <div class="row">
        <div class="p-0 order-2 order-md-1 col-lg-6 card">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15861.837314680703!2d108.331134!3d-6.334494!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x3baf3c8573c40d47!2sStudio%20Supernova!5e0!3m2!1sid!2sid!4v1572851061384!5m2!1sid!2sid" width="570" height="450" frameborder="0" style="border:1;" allowfullscreen=""></iframe> </div>

        <div class="px-4 order-1 order-md-2 col-lg-6 card">
        <br>
          <h2 class="mb-4" contenteditable="true">Kontak Formulir</h2>
          <form>
